        ...
        <div className="lastest-news__news" id="lastestNewsNews">
          <div className="lastest-news__new">
            ...
            <p className="lastest-news__link-paragraph">
              <a href={LastestNewsData[0].href} className="lastest-news__paragraph">
                {LastestNewsData[0].paragraph}
              </a>
            </p>
          </div>
          ...
          <div className="lastest-news__new">
            ...
            <p className="lastest-news__link-paragraph">
              <a href={LastestNewsData[1].href} className="lastest-news__paragraph">
                {LastestNewsData[1].paragraph}
              </a>
            </p>
          </div>
          ...
          <div className="lastest-news__new">
            ...
            <p className="lastest-news__link-paragraph">
              <a href={LastestNewsData[2].href} className="lastest-news__paragraph">
                {LastestNewsData[2].paragraph}
              </a>
            </p>
          </div>
        </div>
